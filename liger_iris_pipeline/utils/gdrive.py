...
def download_gdrive_file(
    ...
    preserve_github_path: bool = True,
    use_cached : bool = True
) -> str | None:
    """
    Download a file from the HISPEC_PARVI_Test_Data google drive folder.
    
    Args:
        rel_file_path (str): Path to the file in the HISPEC_Test_Data repository.
        output_dir (str, optional): Local directory to save the file (default: current directory).
        preserve_rel_path (bool, optional): Preserve the relative path in the output directory (default: True)
    ...
    """
    shared_folder_url = "https://drive.google.com/drive/folders/1y7dPZp-dqNuMgQVTiZJyiUZVVL9v1vOj"
    # https://drive.google.com/drive/u/1/folders/1y7dPZp-dqNuMgQVTiZJyiUZVVL9v1vOj
    # 
